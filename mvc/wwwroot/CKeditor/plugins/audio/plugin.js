...
var tr = {
		toolbar	: 'Ses',
		dialogTitle : 'Ses Ozellikleri',
		fakeObject : 'Ses',
		properties : 'Sesi Duzenle',
		sourceAudio: 'Ses Kaynagi',
		sourceType : 'Ses Turu',
		linkTemplate :  '<a href="%src%">%type%</a> ',
		fallbackTemplate : 'Tarayiciniz ses etiketini desteklemiyor.<br>Lutfen dosyayi indirin: %links%',
		mainTabTitle: 'Ekle',
		uploadTabTitle : 'Yukle'
	};
...
CKEDITOR.plugins.setLang( 'audio', 'tr', tr );
